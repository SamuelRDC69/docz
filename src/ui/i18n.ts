...
export const en = {
  wax: {
    ...
    notConnected: "WAX wallet not connected",
    wallet: "Wallet: {account}",
    disconnect: "Disconnect",
    market: "Character Market",
    marketTitle: "Character NFT Market",
    marketEmpty: "No characters are listed for sale right now.",
    forSale: "For sale",
    yourNfts: "Your character NFTs",
    close: "Close",
    mint: "Mint as NFT",
    frozen: "Frozen — NFT",
    viewNft: "View NFT",
    mustPrestige: "Prestige to mint",
    netWorth: "Net worth: {value}",
    prestige: "Prestige {rank}",
    cardLine: "Level {level} {className}",
    price: "Price: {price}",
    seller: "Seller: {seller}",
    buy: "Buy",
    redeem: "Redeem",
    working: "Working…",
    buyDone: "Purchased! Connect this wallet to your account and redeem to play.",
    redeemDone: "Redeemed! The character is now yours.",
    linkDone: "Wallet linked.",
    mintDone: "Minted! Your character is now an NFT.",
    mintConfirm: "Mint {name} as an NFT for {fee}? The character will be frozen until the NFT is redeemed.",
    redeemConfirm: "Redeem this character for {fee}? The NFT will be consumed.",
    actionFailed: "Wallet action failed. Please try again.",
    errUnavailable: "NFT features aren't available on this realm.",
    errWalletElsewhere: "That WAX wallet is already linked to another account.",
    errLinkFailed: "Could not verify wallet ownership. Please try again.",
    errLinkFirst: "Connect your WAX wallet first.",
    errNotEligible: "This character must prestige before it can be minted.",
    errAlreadyMinted: "This character is minted as an NFT.",
    errPaymentUsed: "That payment was already used.",
    errMintFailed: "Mint failed — the fee payment was not found.",
    errRedeemFailed: "Redeem failed — the payment or NFT transfer was not found.",
  },
...
export const es: typeof en = {
  wax: {
    connectWallet: "Conectar cartera WAX",
    notConnected: "Cartera WAX no conectada",
    wallet: "Cartera: {account}",
    disconnect: "Desconectar",
    market: "Mercado de personajes",
    marketTitle: "Mercado de NFT de personajes",
    marketEmpty: "No hay personajes en venta en este momento.",
    forSale: "En venta",
    yourNfts: "Tus NFT de personaje",
    close: "Cerrar",
    mint: "Acuñar como NFT",
    frozen: "Congelado — NFT",
    viewNft: "Ver NFT",
    mustPrestige: "Prestigia para acuñar",
    netWorth: "Patrimonio: {value}",
    prestige: "Prestigio {rank}",
    cardLine: "Nivel {level} {className}",
    price: "Precio: {price}",
    seller: "Vendedor: {seller}",
    buy: "Comprar",
    redeem: "Canjear",
    working: "Procesando…",
    buyDone: "¡Comprado! Vincula esta cartera a tu cuenta y canjéalo para jugar.",
    redeemDone: "¡Canjeado! El personaje ahora es tuyo.",
    linkDone: "Cartera vinculada.",
    mintDone: "¡Acuñado! Tu personaje ahora es un NFT.",
    mintConfirm: "¿Acuñar a {name} como NFT por {fee}? El personaje quedará congelado hasta que se canjee el NFT.",
    redeemConfirm: "¿Canjear este personaje por {fee}? El NFT se consumirá.",
    actionFailed: "La acción de la cartera falló. Inténtalo de nuevo.",
    errUnavailable: "Las funciones de NFT no están disponibles en este reino.",
    errWalletElsewhere: "Esa cartera WAX ya está vinculada a otra cuenta.",
    errLinkFailed: "No se pudo verificar la propiedad de la cartera. Inténtalo de nuevo.",
    errLinkFirst: "Primero conecta tu cartera WAX.",
    errNotEligible: "Este personaje debe prestigiar antes de poder acuñarse.",
    errAlreadyMinted: "Este personaje está acuñado como NFT.",
    errPaymentUsed: "Ese pago ya se utilizó.",
    errMintFailed: "Falló la acuñación: no se encontró el pago de la tarifa.",
    errRedeemFailed: "Falló el canje: no se encontró el pago o la transferencia del NFT.",
  },
...
export const fr_FR: typeof en = {
  wax: {
    connectWallet: "Connecter le portefeuille WAX",
    notConnected: "Portefeuille WAX non connecté",
    wallet: "Portefeuille : {account}",
    disconnect: "Déconnecter",
    market: "Marché des personnages",
    marketTitle: "Marché NFT de personnages",
    marketEmpty: "Aucun personnage n'est en vente pour le moment.",
    forSale: "À vendre",
    yourNfts: "Vos NFT de personnage",
    close: "Fermer",
    mint: "Frapper en NFT",
    frozen: "Gelé — NFT",
    viewNft: "Voir le NFT",
    mustPrestige: "Prestige requis pour frapper",
    netWorth: "Valeur nette : {value}",
    prestige: "Prestige {rank}",
    cardLine: "Niveau {level} {className}",
    price: "Prix : {price}",
    seller: "Vendeur : {seller}",
    buy: "Acheter",
    redeem: "Échanger",
    working: "Traitement…",
    buyDone: "Acheté ! Liez ce portefeuille à votre compte et échangez-le pour jouer.",
    redeemDone: "Échangé ! Le personnage est désormais à vous.",
    linkDone: "Portefeuille lié.",
    mintDone: "Frappé ! Votre personnage est désormais un NFT.",
    mintConfirm: "Frapper {name} en NFT pour {fee} ? Le personnage sera gelé jusqu'à l'échange du NFT.",
    redeemConfirm: "Échanger ce personnage pour {fee} ? Le NFT sera consommé.",
    actionFailed: "L'action du portefeuille a échoué. Veuillez réessayer.",
    errUnavailable: "Les fonctions NFT ne sont pas disponibles sur ce royaume.",
    errWalletElsewhere: "Ce portefeuille WAX est déjà lié à un autre compte.",
    errLinkFailed: "Impossible de vérifier la propriété du portefeuille. Veuillez réessayer.",
    errLinkFirst: "Connectez d'abord votre portefeuille WAX.",
    errNotEligible: "Ce personnage doit atteindre le prestige avant d'être frappé.",
    errAlreadyMinted: "Ce personnage est frappé en NFT.",
    errPaymentUsed: "Ce paiement a déjà été utilisé.",
    errMintFailed: "Échec de la frappe — le paiement des frais est introuvable.",
    errRedeemFailed: "Échec de l'échange — le paiement ou le transfert du NFT est introuvable.",
  },
...
export const it_IT: typeof en = {
  wax: {
    connectWallet: "Collega portafoglio WAX",
    notConnected: "Portafoglio WAX non collegato",
    wallet: "Portafoglio: {account}",
    disconnect: "Disconnetti",
    market: "Mercato dei personaggi",
    marketTitle: "Mercato NFT dei personaggi",
    marketEmpty: "Nessun personaggio in vendita al momento.",
    forSale: "In vendita",
    yourNfts: "I tuoi NFT personaggio",
    close: "Chiudi",
    mint: "Conia come NFT",
    frozen: "Congelato — NFT",
    viewNft: "Vedi NFT",
    mustPrestige: "Serve il prestigio per coniare",
    netWorth: "Patrimonio: {value}",
    prestige: "Prestigio {rank}",
    cardLine: "Livello {level} {className}",
    price: "Prezzo: {price}",
    seller: "Venditore: {seller}",
    buy: "Compra",
    redeem: "Riscatta",
    working: "Elaborazione…",
    buyDone: "Acquistato! Collega questo portafoglio al tuo account e riscattalo per giocare.",
    redeemDone: "Riscattato! Il personaggio ora è tuo.",
    linkDone: "Portafoglio collegato.",
    mintDone: "Coniato! Il tuo personaggio ora è un NFT.",
    mintConfirm: "Coniare {name} come NFT per {fee}? Il personaggio sarà congelato finché l'NFT non verrà riscattato.",
    redeemConfirm: "Riscattare questo personaggio per {fee}? L'NFT verrà consumato.",
    actionFailed: "Azione del portafoglio non riuscita. Riprova.",
    errUnavailable: "Le funzioni NFT non sono disponibili in questo regno.",
    errWalletElsewhere: "Quel portafoglio WAX è già collegato a un altro account.",
    errLinkFailed: "Impossibile verificare la proprietà del portafoglio. Riprova.",
    errLinkFirst: "Collega prima il tuo portafoglio WAX.",
    errNotEligible: "Questo personaggio deve raggiungere il prestigio prima di essere coniato.",
    errAlreadyMinted: "Questo personaggio è coniato come NFT.",
    errPaymentUsed: "Quel pagamento è già stato usato.",
    errMintFailed: "Conio non riuscito — pagamento della commissione non trovato.",
    errRedeemFailed: "Riscatto non riuscito — pagamento o trasferimento dell'NFT non trovato.",
  },
...
export const de_DE: typeof en = {
  wax: {
    connectWallet: "WAX-Wallet verbinden",
    notConnected: "WAX-Wallet nicht verbunden",
    wallet: "Wallet: {account}",
    disconnect: "Trennen",
    market: "Charaktermarkt",
    marketTitle: "Charakter-NFT-Markt",
    marketEmpty: "Derzeit stehen keine Charaktere zum Verkauf.",
    forSale: "Zum Verkauf",
    yourNfts: "Deine Charakter-NFTs",
    close: "Schließen",
    mint: "Als NFT prägen",
    frozen: "Eingefroren — NFT",
    viewNft: "NFT ansehen",
    mustPrestige: "Prestige zum Prägen nötig",
    netWorth: "Vermögen: {value}",
    prestige: "Prestige {rank}",
    cardLine: "Stufe {level} {className}",
    price: "Preis: {price}",
    seller: "Verkäufer: {seller}",
    buy: "Kaufen",
    redeem: "Einlösen",
    working: "Wird bearbeitet…",
    buyDone: "Gekauft! Verknüpfe diese Wallet mit deinem Konto und löse sie ein, um zu spielen.",
    redeemDone: "Eingelöst! Der Charakter gehört jetzt dir.",
    linkDone: "Wallet verknüpft.",
    mintDone: "Geprägt! Dein Charakter ist jetzt ein NFT.",
    mintConfirm: "{name} für {fee} als NFT prägen? Der Charakter wird eingefroren, bis das NFT eingelöst wird.",
    redeemConfirm: "Diesen Charakter für {fee} einlösen? Das NFT wird verbraucht.",
    actionFailed: "Wallet-Aktion fehlgeschlagen. Bitte erneut versuchen.",
    errUnavailable: "NFT-Funktionen sind in diesem Reich nicht verfügbar.",
    errWalletElsewhere: "Diese WAX-Wallet ist bereits mit einem anderen Konto verknüpft.",
    errLinkFailed: "Wallet-Eigentum konnte nicht überprüft werden. Bitte erneut versuchen.",
    errLinkFirst: "Verbinde zuerst deine WAX-Wallet.",
    errNotEligible: "Dieser Charakter muss erst Prestige erreichen, bevor er geprägt werden kann.",
    errAlreadyMinted: "Dieser Charakter ist als NFT geprägt.",
    errPaymentUsed: "Diese Zahlung wurde bereits verwendet.",
    errMintFailed: "Prägen fehlgeschlagen — Gebührenzahlung nicht gefunden.",
    errRedeemFailed: "Einlösen fehlgeschlagen — Zahlung oder NFT-Übertragung nicht gefunden.",
  },
...
export const zh_CN: typeof en = {
  wax: {
    connectWallet: "连接 WAX 钱包",
    notConnected: "WAX 钱包未连接",
    wallet: "钱包：{account}",
    disconnect: "断开连接",
    market: "角色市场",
    marketTitle: "角色 NFT 市场",
    marketEmpty: "目前没有角色在售。",
    forSale: "在售",
    yourNfts: "你的角色 NFT",
    close: "关闭",
    mint: "铸造为 NFT",
    frozen: "已冻结 — NFT",
    viewNft: "查看 NFT",
    mustPrestige: "需先转生才能铸造",
    netWorth: "净资产：{value}",
    prestige: "转生 {rank}",
    cardLine: "{level} 级 {className}",
    price: "价格：{price}",
    seller: "卖家：{seller}",
    buy: "购买",
    redeem: "赎回",
    working: "处理中…",
    buyDone: "已购买！将此钱包关联到你的账号并赎回即可游玩。",
    redeemDone: "已赎回！该角色现在属于你。",
    linkDone: "钱包已关联。",
    mintDone: "已铸造！你的角色现在是 NFT。",
    mintConfirm: "以 {fee} 将 {name} 铸造为 NFT？在 NFT 被赎回前，该角色将被冻结。",
    redeemConfirm: "以 {fee} 赎回该角色？该 NFT 将被销毁。",
    actionFailed: "钱包操作失败，请重试。",
    errUnavailable: "此服务器不支持 NFT 功能。",
    errWalletElsewhere: "该 WAX 钱包已关联到其他账号。",
    errLinkFailed: "无法验证钱包所有权，请重试。",
    errLinkFirst: "请先连接你的 WAX 钱包。",
    errNotEligible: "该角色必须先转生才能铸造。",
    errAlreadyMinted: "该角色已铸造为 NFT。",
    errPaymentUsed: "该笔支付已被使用。",
    errMintFailed: "铸造失败——未找到费用支付。",
    errRedeemFailed: "赎回失败——未找到支付或 NFT 转移。",
  },
...
export const zh_TW: typeof en = {
  wax: {
    connectWallet: "連接 WAX 錢包",
    notConnected: "WAX 錢包未連接",
    wallet: "錢包：{account}",
    disconnect: "中斷連接",
    market: "角色市場",
    marketTitle: "角色 NFT 市場",
    marketEmpty: "目前沒有角色出售。",
    forSale: "出售中",
    yourNfts: "你的角色 NFT",
    close: "關閉",
    mint: "鑄造為 NFT",
    frozen: "已凍結 — NFT",
    viewNft: "檢視 NFT",
    mustPrestige: "需先轉生才能鑄造",
    netWorth: "淨資產：{value}",
    prestige: "轉生 {rank}",
    cardLine: "{level} 級 {className}",
    price: "價格：{price}",
    seller: "賣家：{seller}",
    buy: "購買",
    redeem: "贖回",
    working: "處理中…",
    buyDone: "已購買！將此錢包關聯到你的帳號並贖回即可遊玩。",
    redeemDone: "已贖回！該角色現在屬於你。",
    linkDone: "錢包已關聯。",
    mintDone: "已鑄造！你的角色現在是 NFT。",
    mintConfirm: "以 {fee} 將 {name} 鑄造為 NFT？在 NFT 被贖回前，該角色將被凍結。",
    redeemConfirm: "以 {fee} 贖回該角色？該 NFT 將被銷毀。",
    actionFailed: "錢包操作失敗，請重試。",
    errUnavailable: "此伺服器不支援 NFT 功能。",
    errWalletElsewhere: "該 WAX 錢包已關聯到其他帳號。",
    errLinkFailed: "無法驗證錢包所有權，請重試。",
    errLinkFirst: "請先連接你的 WAX 錢包。",
    errNotEligible: "該角色必須先轉生才能鑄造。",
    errAlreadyMinted: "該角色已鑄造為 NFT。",
    errPaymentUsed: "該筆付款已被使用。",
    errMintFailed: "鑄造失敗——找不到費用付款。",
    errRedeemFailed: "贖回失敗——找不到付款或 NFT 轉移。",
  },
...
export const ko_KR: typeof en = {
  wax: {
    connectWallet: "WAX 지갑 연결",
    notConnected: "WAX 지갑이 연결되지 않음",
    wallet: "지갑: {account}",
    disconnect: "연결 해제",
    market: "캐릭터 시장",
    marketTitle: "캐릭터 NFT 시장",
    marketEmpty: "현재 판매 중인 캐릭터가 없습니다.",
    forSale: "판매 중",
    yourNfts: "내 캐릭터 NFT",
    close: "닫기",
    mint: "NFT로 발행",
    frozen: "동결됨 — NFT",
    viewNft: "NFT 보기",
    mustPrestige: "발행하려면 프레스티지 필요",
    netWorth: "순자산: {value}",
    prestige: "프레스티지 {rank}",
    cardLine: "{level}레벨 {className}",
    price: "가격: {price}",
    seller: "판매자: {seller}",
    buy: "구매",
    redeem: "교환",
    working: "처리 중…",
    buyDone: "구매 완료! 이 지갑을 계정에 연결하고 교환하면 플레이할 수 있습니다.",
    redeemDone: "교환 완료! 이제 캐릭터는 당신의 것입니다.",
    linkDone: "지갑이 연결되었습니다.",
    mintDone: "발행 완료! 이제 캐릭터가 NFT입니다.",
    mintConfirm: "{name}을(를) {fee}에 NFT로 발행할까요? NFT가 교환될 때까지 캐릭터가 동결됩니다.",
    redeemConfirm: "이 캐릭터를 {fee}에 교환할까요? NFT가 소각됩니다.",
    actionFailed: "지갑 작업에 실패했습니다. 다시 시도해 주세요.",
    errUnavailable: "이 서버에서는 NFT 기능을 사용할 수 없습니다.",
    errWalletElsewhere: "해당 WAX 지갑은 이미 다른 계정에 연결되어 있습니다.",
    errLinkFailed: "지갑 소유권을 확인할 수 없습니다. 다시 시도해 주세요.",
    errLinkFirst: "먼저 WAX 지갑을 연결하세요.",
    errNotEligible: "이 캐릭터는 발행하기 전에 프레스티지를 해야 합니다.",
    errAlreadyMinted: "이 캐릭터는 NFT로 발행되었습니다.",
    errPaymentUsed: "해당 결제는 이미 사용되었습니다.",
    errMintFailed: "발행 실패 — 수수료 결제를 찾을 수 없습니다.",
    errRedeemFailed: "교환 실패 — 결제 또는 NFT 전송을 찾을 수 없습니다.",
  },
...
export const ja_JP: typeof en = {
  wax: {
    connectWallet: "WAXウォレットを接続",
    notConnected: "WAXウォレット未接続",
    wallet: "ウォレット: {account}",
    disconnect: "切断",
    market: "キャラクター市場",
    marketTitle: "キャラクターNFT市場",
    marketEmpty: "現在、販売中のキャラクターはありません。",
    forSale: "販売中",
    yourNfts: "あなたのキャラクターNFT",
    close: "閉じる",
    mint: "NFTとして発行",
    frozen: "凍結中 — NFT",
    viewNft: "NFTを見る",
    mustPrestige: "発行にはプレステージが必要",
    netWorth: "純資産: {value}",
    prestige: "プレステージ {rank}",
    cardLine: "レベル{level} {className}",
    price: "価格: {price}",
    seller: "出品者: {seller}",
    buy: "購入",
    redeem: "引き換え",
    working: "処理中…",
    buyDone: "購入しました！このウォレットをアカウントに連携し、引き換えるとプレイできます。",
    redeemDone: "引き換え完了！キャラクターはあなたのものになりました。",
    linkDone: "ウォレットを連携しました。",
    mintDone: "発行しました！キャラクターはNFTになりました。",
    mintConfirm: "{name}を{fee}でNFTとして発行しますか？NFTが引き換えられるまでキャラクターは凍結されます。",
    redeemConfirm: "このキャラクターを{fee}で引き換えますか？NFTは消費されます。",
    actionFailed: "ウォレット操作に失敗しました。もう一度お試しください。",
    errUnavailable: "このレルムではNFT機能を利用できません。",
    errWalletElsewhere: "そのWAXウォレットは既に別のアカウントに連携されています。",
    errLinkFailed: "ウォレットの所有権を確認できませんでした。もう一度お試しください。",
    errLinkFirst: "先にWAXウォレットを接続してください。",
    errNotEligible: "このキャラクターは発行前にプレステージする必要があります。",
    errAlreadyMinted: "このキャラクターはNFTとして発行されています。",
    errPaymentUsed: "その支払いは既に使用されています。",
    errMintFailed: "発行に失敗しました — 手数料の支払いが見つかりません。",
    errRedeemFailed: "引き換えに失敗しました — 支払いまたはNFTの送付が見つかりません。",
  },
...
export const pt_BR: typeof en = {
  wax: {
    connectWallet: "Conectar carteira WAX",
    notConnected: "Carteira WAX não conectada",
    wallet: "Carteira: {account}",
    disconnect: "Desconectar",
    market: "Mercado de personagens",
    marketTitle: "Mercado de NFT de personagens",
    marketEmpty: "Nenhum personagem à venda no momento.",
    forSale: "À venda",
    yourNfts: "Seus NFTs de personagem",
    close: "Fechar",
    mint: "Cunhar como NFT",
    frozen: "Congelado — NFT",
    viewNft: "Ver NFT",
    mustPrestige: "Prestígio necessário para cunhar",
    netWorth: "Patrimônio: {value}",
    prestige: "Prestígio {rank}",
    cardLine: "Nível {level} {className}",
    price: "Preço: {price}",
    seller: "Vendedor: {seller}",
    buy: "Comprar",
    redeem: "Resgatar",
    working: "Processando…",
    buyDone: "Comprado! Vincule esta carteira à sua conta e resgate para jogar.",
    redeemDone: "Resgatado! O personagem agora é seu.",
    linkDone: "Carteira vinculada.",
    mintDone: "Cunhado! Seu personagem agora é um NFT.",
    mintConfirm: "Cunhar {name} como NFT por {fee}? O personagem ficará congelado até que o NFT seja resgatado.",
    redeemConfirm: "Resgatar este personagem por {fee}? O NFT será consumido.",
    actionFailed: "A ação da carteira falhou. Tente novamente.",
    errUnavailable: "Os recursos de NFT não estão disponíveis neste reino.",
    errWalletElsewhere: "Essa carteira WAX já está vinculada a outra conta.",
    errLinkFailed: "Não foi possível verificar a posse da carteira. Tente novamente.",
    errLinkFirst: "Conecte sua carteira WAX primeiro.",
    errNotEligible: "Este personagem precisa de prestígio antes de ser cunhado.",
    errAlreadyMinted: "Este personagem está cunhado como NFT.",
    errPaymentUsed: "Esse pagamento já foi utilizado.",
    errMintFailed: "Falha na cunhagem — o pagamento da taxa não foi encontrado.",
    errRedeemFailed: "Falha no resgate — o pagamento ou a transferência do NFT não foi encontrado.",
  },
...
export const ru_RU: typeof en = {
  wax: {
    connectWallet: "Подключить кошелёк WAX",
    notConnected: "Кошелёк WAX не подключён",
    wallet: "Кошелёк: {account}",
    disconnect: "Отключить",
    market: "Рынок персонажей",
    marketTitle: "NFT-рынок персонажей",
    marketEmpty: "Сейчас нет персонажей в продаже.",
    forSale: "В продаже",
    yourNfts: "Ваши NFT персонажей",
    close: "Закрыть",
    mint: "Выпустить как NFT",
    frozen: "Заморожен — NFT",
    viewNft: "Посмотреть NFT",
    mustPrestige: "Для выпуска нужен престиж",
    netWorth: "Состояние: {value}",
    prestige: "Престиж {rank}",
    cardLine: "Уровень {level}, {className}",
    price: "Цена: {price}",
    seller: "Продавец: {seller}",
    buy: "Купить",
    redeem: "Обменять",
    working: "Обработка…",
    buyDone: "Куплено! Привяжите этот кошелёк к аккаунту и выкупите, чтобы играть.",
    redeemDone: "Выкуплено! Персонаж теперь ваш.",
    linkDone: "Кошелёк привязан.",
    mintDone: "Выпущено! Ваш персонаж теперь NFT.",
    mintConfirm: "Выпустить {name} как NFT за {fee}? Персонаж будет заморожен до выкупа NFT.",
    redeemConfirm: "Выкупить этого персонажа за {fee}? NFT будет уничтожен.",
    actionFailed: "Действие кошелька не удалось. Повторите попытку.",
    errUnavailable: "Функции NFT недоступны в этом мире.",
    errWalletElsewhere: "Этот кошелёк WAX уже привязан к другому аккаунту.",
    errLinkFailed: "Не удалось подтвердить владение кошельком. Повторите попытку.",
    errLinkFirst: "Сначала подключите кошелёк WAX.",
    errNotEligible: "Этот персонаж должен получить престиж перед выпуском.",
    errAlreadyMinted: "Этот персонаж выпущен как NFT.",
    errPaymentUsed: "Этот платёж уже использован.",
    errMintFailed: "Не удалось выпустить — платёж комиссии не найден.",
    errRedeemFailed: "Не удалось выкупить — платёж или перевод NFT не найден.",
  },
